...
public class ServerAsteroidGenerator {
    ...
    private List<Asteroid> currentAsteroids;
    ...
    public void generateAsteroids(){
        List<Asteroid> _asteroids = new ArrayList<>();
        ...
        while (_asteroids.size() < amountOfAsteroids) {
            ...
            if(!isColliding(rMapUnitX, rMapUnitY, rResourceAmount, _asteroids) || _asteroids.isEmpty()){
                _asteroids.add(new Asteroid(AsteroidType.common, rResourceAmount, rMapUnitX * 10, rMapUnitY * 10));
            }
        }
    ...
    private boolean isColliding(int posUnitX, int posUnitY, int resourceAmount, Collection<Asteroid> checkAsteroids){
        ...
        for(Asteroid asteroid : checkAsteroids){
